  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
      <div className="max-w-xl w-full">
        <p className="font-mono text-[10px] tracking-[.18em] text-faint uppercase mb-3">Step 2 of 3</p>
        ...
        <section className="mb-8">
          ...
          <input
            ...
            className="w-full px-3 py-2.5 border border-mist rounded-[10px] text-[13.5px] text-ink bg-white focus:outline-none focus:border-accent placeholder:text-faint"
          />
        </section>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-[13px] border transition-all
                  ${niches.includes(n.id)
                    ...
                    : 'bg-white border-[#E1DBCD] text-[#6C6555] hover:border-accent/50'
                  }`}
              >
                {n.label}
              </button>
        ...
        <section className="mb-8">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              min="0"
              className="w-28 px-3 py-2 border border-[#E1DBCD] rounded-[10px] font-mono text-[13px] bg-white focus:outline-none focus:border-accent"
            />
        ...
        <section className="mb-10">
          ...
          <textarea
            ...
            className="w-full px-3 py-2.5 border border-mist rounded-[10px] text-[13.5px] text-ink bg-white focus:outline-none focus:border-accent resize-none placeholder:text-faint"
          />
        </section>
        ...
        <button
          onClick={handleStart}
          disabled={!canStart}
          className={`w-full flex items-center justify-center gap-2 py-[13px] rounded-[12px] font-semibold text-[13.5px] transition-all
            ${canStart
